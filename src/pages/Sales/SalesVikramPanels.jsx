...
export default function SalesVikramPanels() {
  return (
    <div className="pt-20">
      <section className="pad-xl bg-gradient-to-br from-green-50 to-yellow-50">
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="heading-1 mb-6">Vikram Solar Panels</h1>
            <p className="body-large text-gray-600 mb-8">
              High-efficiency solar panels with 25 to 30 years warranty. Premium quality monocrystalline panels 
              designed for maximum power output and long-term reliability.
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between border-b pb-3">
                  ...
                  <span className="body-medium text-green-600 font-semibold">540wp-590wp</span>
                </div>
                <div className="flex justify-between border-b pb-3">
                  <span className="body-medium font-medium">Efficiency:</span>
                  <span className="body-medium text-green-600 font-semibold">21%-23%</span>
                </div>
                <div className="flex justify-between border-b pb-3">
                  <span className="body-medium font-medium">Warranty:</span>
                  <span className="body-medium text-green-600 font-semibold">25-30 years</span>
                </div>
                <div className="flex justify-between border-b pb-3">
      ...
      <section className="pad-xl bg-gray-50">
        <div className="container">
          <h2 className="heading-2 text-center mb-12">Why Choose Vikram Solar Panels?</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <Award className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="heading-3 mb-3">Premium Quality</h3>
              <p className="body-small text-gray-600">Top-tier monocrystalline solar panels from trusted manufacturer</p>
            </div>
            <div className="text-center">
              <Shield className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="heading-3 mb-3">Extended Warranty</h3>
              <p className="body-small text-gray-600">25-30 years warranty coverage for peace of mind</p>
            </div>
            <div className="text-center">
              <Zap className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="heading-3 mb-3">High Efficiency</h3>
              <p className="body-small text-gray-600">21-23% efficiency for maximum power generation</p>
            </div>
            <div className="text-center">
      ...
      <section className="pad-xl bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container text-center">
          <h2 className="heading-2 text-white mb-4">Ready to Go Solar with Vikram?</h2>
          <p className="body-large text-green-100 mb-8 max-w-2xl mx-auto">
            Choose premium Vikram Solar Panels and start your journey towards energy independence today.
          </p>
