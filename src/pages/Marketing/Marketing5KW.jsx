...
export default function Marketing5KW() {
  const system = marketingSystems['5kw'];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="pad-xl bg-gray-50">
        <div className="container">
          <h2 className="heading-2 text-center mb-12">Why Choose 5KW Systems?</h2>
      ...
      <section className="pad-xl bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container text-center">
          <h2 className="heading-2 text-white mb-4">Upgrade to 5KW Solar Power</h2>
          <p className="body-large text-green-100 mb-8 max-w-2xl mx-auto">
            Experience enhanced energy independence with our 5KW solar systems. 
