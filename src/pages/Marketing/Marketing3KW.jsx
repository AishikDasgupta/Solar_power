...
export default function Marketing3KW() {
  const system = marketingSystems['3kw'];
  ...
  return (
    <div className="pt-20">
      ...
      <section className="pad-xl bg-gray-50">
        <div className="container">
          <h2 className="heading-2 text-center mb-12">Why Choose 3KW Systems?</h2>
      ...
      <section className="pad-xl bg-gradient-to-r from-green-600 to-green-700 text-white">
        <div className="container text-center">
          <h2 className="heading-2 text-white mb-4">Ready for Your 3KW Solar System?</h2>
          <p className="body-large text-green-100 mb-8 max-w-2xl mx-auto">
            Get a customized 3KW solar solution designed for your specific energy needs. 
